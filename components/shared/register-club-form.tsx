  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-4">
      ...
      <div className="flex flex-col gap-1.5">
        ...
        <Input id="tenantName" name="tenantName" required placeholder="Kolam Renang Melati" />
      </div>
      <div className="flex flex-col gap-1.5">
        <Label htmlFor="tenantSlug">Kode Klub</Label>
        <Input id="tenantSlug" name="tenantSlug" required placeholder="melati" />
        <p className="text-xs text-muted-foreground">
          Dipakai saat login, hanya huruf kecil/angka/tanda hubung.
        </p>
      </div>
      <div className="flex flex-col gap-1.5">
        <Label htmlFor="adminFullName">Nama Anda</Label>
        <Input id="adminFullName" name="adminFullName" required autoComplete="name" />
      </div>
      <div className="flex flex-col gap-1.5">
      ...
      <div className="flex flex-col gap-1.5">
        ...
        />
        <p className="text-xs text-muted-foreground">Minimal 8 karakter, ada huruf dan angka.</p>
      </div>
